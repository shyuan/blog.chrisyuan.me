...
一太郎和 ATOK 都還在。ATOK Passport 在 2026 年 2 月加入了生成式 AI 寫作助理「ATOK MiRA」，6 月擴及 macOS、Android 和 iOS。法人端有無程式碼雲端資料庫「JUST.DB」、營業支援「JUST.SFA」和 BI 工具「Actionista!」。至於 Homepage Builder，仍然列在個人產品線裡，排在一太郎、ATOK 和 PDF 軟體後面。
...
第一件是在地化的麻煩事。第 23 版新增 20 種設計範本，總數到 120 種，組合起來官方號稱約 9,700 種；另外附了一批業種資訊，包括食品廠商、小兒牙科、神社和寺院。你很難想像海外的網站建置服務，會替神社準備一套專用範本。

### 醫療法規的截止日

更關鍵的是醫療法規。第 23 版的 Just MyShop 產品頁寫著：「保険医療機関・保険薬局・指定訪問看護事業者における書面掲示事項等についての掲示に対応しました。必要な掲示事項も漏れなく組み込んだホームページ作成が可能です。」
