...
這裡要幫國民政府講句公道話。對它自己而言，這未必是「明知未必為真而逕自宣告」。在它的法理邏輯裡，開羅宣言加上波茨坦公告已經構成主權回歸，那道訓令不是編造，而是把它自認已經成立的事寫下來。問題出在這套說法同盟國與日方都不埋單，並未取得共識，於是在別人眼中，它就變成了一個把存疑當已然、還要求他人接受的宣告。也正因如此，它跟第十條那個誠實的、框了範圍的 deem，才是兩種不同的東西。
